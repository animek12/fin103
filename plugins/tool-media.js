...
let img = await q.download?.()
    ...
    let res = `https://api.lolhuman.xyz/api/convert/towebp?apikey=2da1fcd209f20ae428d8482f&img=${url}`
...
let q = m.quoted ? m.quoted : m
    ...
    let img = await q.download?.()
    let url = await uploadImage(img)
    let res = `https://api.lolhuman.xyz/api/convert/towebpwround?apikey=2da1fcd209f20ae428d8482f&img=${url}`
await conn.sendFile(m.chat, res, 'out.webp', m, false, { mimetype: 'image/webp', thumbnail: Buffer.alloc(0) })
}
...
let q = m.quoted ? m.quoted : m
    ...
    let img = await q.download?.()
   // let url = await uploadImage(img)
    let res = `https://api.lolhuman.xyz/api/convert/webptogif?apikey=2da1fcd209f20ae428d8482f&img=${img}`
...
let q = m.quoted ? m.quoted : m
    ...
    let img = await q.download?.()
   // let url = await uploadImage(img)
    let res = `https://api.lolhuman.xyz/api/convert/webptomp4?apikey=2da1fcd209f20ae428d8482f&img=${img}`
...
let q = m.quoted ? m.quoted : m
    ...
    let img = await q.download?.()
    // let url = await uploadImage(img)
    let res = `https://api.lolhuman.xyz/api/convert/imgtopdf?apikey=2da1fcd209f20ae428d8482f&img=${img}`
...
let q = m.quoted ? m.quoted : m
    ...
    let img = await q.download?.()
   // let url = await uploadImage(img)
    let res = `https://api.lolhuman.xyz/api/convert/topng?apikey=2da1fcd209f20ae428d8482f&img=${img}`
...
let q = m.quoted ? m.quoted : m
    ...
    let res = `https://api.lolhuman.xyz/api/filetobase64?apikey=2da1fcd209f20ae428d8482f&file=${img}`
await conn.sendFile(m.chat, res, 'Hasil', '', m)
}

if (command == '64tofile') {
if (!text) throw `balas gambar dengan perintah\n\n${usedPrefix + command} base64`
let res = `https://api.lolhuman.xyz/api/base64tofile?apikey=2da1fcd209f20ae428d8482f&base=${text}`
await conn.sendFile(m.chat, res, 'Hasil', '', m)
}

if (command == 'urltoimg') {
if (!text) throw `balas gambar dengan perintah\n\n${usedPrefix + command} url`
let res = `https://api.lolhuman.xyz/api/urltoimg?apikey=2da1fcd209f20ae428d8482f&url=${text}`
...
let q = m.quoted ? m.quoted : m
    ...
    let img = await q.download?.()
   // let url = await uploadImage(img)
    let res = await fetch(`https://api.lolhuman.xyz/api/filetourl?apikey=2da1fcd209f20ae428d8482f&file=${img}`)
...
let res = await fetch(`https://api.lolhuman.xyz/api/morse/encrypt?apikey=2da1fcd209f20ae428d8482f&text=${text}`)
    let p = await res.json()
    let rem = p.result
    await m.reply(`*Result:* ${rem}`)
}
...
let res = await fetch(`https://api.lolhuman.xyz/api/morse/decrypt?apikey=2da1fcd209f20ae428d8482f&text=${text}`)
    let p = await res.json()
    let rem = p.result
    await m.reply(`*Result:* ${rem}`)
}
...
let urut = text.split`+`
  ...
  let text2 = urut[1]
    ...
    let res = `https://api.lolhuman.xyz/api/emojimix/${text1}+${text2}?apikey=2da1fcd209f20ae428d8482f`
...
if (command == 'smojimg') {
    ...
    let res = `https://api.lolhuman.xyz/api/smoji/${text}?apikey=2da1fcd209f20ae428d8482f`
await conn.sendFile(m.chat, res, 'out.jpeg', m, false, { mimetype: 'image/jpeg', thumbnail: Buffer.alloc(0) })
}

if (command == 'smojimg2') {
    if (!text) throw `balas gambar dengan perintah\n\n${usedPrefix + command} emoji`
let res = await fetch(`https://api.lolhuman.xyz/api/smoji3/${text}?apikey=2da1fcd209f20ae428d8482f`)
    let p = await res.json()
    let x = p.result
    const sections = [
    {
